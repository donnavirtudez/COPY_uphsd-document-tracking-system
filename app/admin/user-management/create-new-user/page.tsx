...
export default function CreateNewUser() {
    ...
    // Dropdown Buttons
    const departmentOptions: string[] = ["Select", "Information Technology", "Medicine", "Business", "Human Resource"];
    const [isDepartmentOptionOpen, setIsDepartmentOptionOpen] = useState<boolean>(false);
  ...
  const positionOptions: string[] = ["Select", "Department Head", "Staff"];
    const [isPositionOptionOpen, setIsPositionOptionOpen] = useState<boolean>(false);
    const [selectedPosition, setSelectedPosition] = useState<string>(positionOptions[0]);
  ...
  return (
            ...
            <div className={styles.formSection}>
                ...
                <div className={styles.personalInformationContainer}>
                    ...
                    <div className={styles.data}>
                        ...
                        <input name='email' placeholder='email@uphsd.edu.ph' type="text" />
                    </div>
                    ...
                    <button 
                    className={`${!isDepartmentOptionOpen ? styles.optionBtn : styles.activeOptionBtn}`}
                    onClick={() => setIsDepartmentOptionOpen(!isDepartmentOptionOpen)}
                    >
                        {selectedDepartment}
                        <span>
                        <svg
    ...
    />
                    ...
                    <button 
                    className={`${!isPositionOptionOpen ? styles.optionBtn : styles.activeOptionBtn}`}
                    onClick={() => setIsPositionOptionOpen(!isPositionOptionOpen)}
                    >
                        {selectedPosition}
                        <span>
                        <svg
